...
var { appDataPath, addScripts, getMimeType } = require('./util')

exports.start = start
exports.stop = stop

function start (startCallback, peerCallback, videoDevice, audioDevice, viewerTemplate) {

  var swarm, block = 0
  var mimeType = getMimeType(videoDevice, audioDevice)
